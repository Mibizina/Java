...
public class EssaiPath {
    ...
    {
        Path rep1 = Paths.get("E:\\Exemples\\Test\\Donnees"); //repert absolu
        Path rep2 = Paths.get("E:\\Exemples\\Resultats\\..\\Test\\Donnees\\..");
        Path rep3 = Paths.get("Essai\\Jour1"); //repert relatif
        Path fic1 = Paths.get("E:\\Exemples\\Test\\Donnees","chose.txt");
