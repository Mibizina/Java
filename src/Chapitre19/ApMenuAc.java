...
public class ApMenuAc extends JApplet implements ActionListener{
    ...
    static public final String [] nomIcones = {"red.gif", "vert.gif", "jaune.gif", "bleu.gif"};
    public void init()
    {
        Container contenu = getContentPane();
        /*création panneau pour les dessins*/
        pan = new Paneau();
        contenu.add(pan);
        ...
        /* creation menus couleurs et ses options*/
        ...
        /* creation de menu surgissant */
        couleurSurg = new JPopupMenu();
        for (int i=0; i< nomCouleurs.length ; i++) couleurSurg.add(actions[i]);
        ...
        /* (avec suppression textes associes et ajout de bulle d'aides */
