...
public class ModifChamps {
    public static void main(String args[]) throws IllegalAccessException
    {
        ...
        // Recuperation des valeurs du premier champ de p1 et de p2
        ...
        // Modification des valeurs du premier champ p1 et de p2
        Integer io = 100;
        champs[0].set(p2, io);
...
class Pointa
{
        public Pointa(){x=0; y=0;}
        public Pointa(int x, int y){this.x = x; this.y = y;}
