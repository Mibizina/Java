...
public class Map1 {
    public static void main (String args[])
    {
        ...
        System.out.println("listes des valeurs apres sup :      " + valeurs);
        ...
        // modification de la valeur associe a la cle x
        String old =m.put("x", "25");
        if (old != null)
        System.out.println("valeur associee a x avant modif:    " + old);
        System.out.println("map apres modif de x :              " + m);
        System.out.println("liste des valeurs apres modif x :   " + valeurs);
        
        // on parcourt les entrees (Map.Entry) du map jusqu'à trouver la valeur 20
        ...
        // on supprime l'élément de cle "f"
        m.remove("f");
