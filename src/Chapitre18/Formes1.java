...
import javax.swing.*;
import java.awt.*;
class MFf1 extends JFrame
{
    public MFf1()
    {
        setTitle("Remplissage de forme");
        setSize(550, 180);
...
class PaneauF1 extends JPanel
{
    public void paintComponent(Graphics g)
    {
        ...
        /** arc jaune bordure rouge plus grande*/
        g.translate(2*r+20, 0);
        g.setColor(Color.yellow); g.fillArc(0, 0, 2*r, 2*r, 45, 145);
