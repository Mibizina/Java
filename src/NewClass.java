...
public class Elgamal implements CipherScheme
{
  ...
  public Elgamal_CipherText Encrypt(Elgamal_PlainText msg, Elgamal_PublicKey pkey) throws Invalid_PublicKey, 
Invalid_PlainText
  { 
    if(pkey == null)
  ...
  public Elgamal_PlainText Decrypt(Elgamal_CipherText msg, Elgamal_SecretKey skey) throws Invalid_SecretKey, 
Invalid_CipherText
  {
    if(skey == null)
  ...
  Elgamal_PlainText plain = new Elgamal_PlainText(new BigInteger(Integer.parseInt(args[0]), generator).mod
(kset.pkey.p));
